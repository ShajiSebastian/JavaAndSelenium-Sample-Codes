...
public class HIS_Store 
{
	...
	public static void main(String args[]) throws IOException
	{
		...
		HIS_Store objReadFile = new HIS_Store();
 	  ...
 	  public void loginApplication(WebDriver driver) throws IOException
 				...
 				Sheet vscSheet = vscWorkbook.getSheet(sheetName);
 	 			...
 	 			//Create a loop over all the rows of excel file to read it
 					...
 					System.out.println ("Login credentials as per test data sheet");
 	 				...
 	 				String userID = row1.getCell(1).getStringCellValue();
 	 				System.out.println ("   User ID  :" + userID);
 	 				
 	 				Row row2 = vscSheet.getRow(2);
 	 			 ...
 	 			 //Invoking application url
 	 	 		 ...
 	 	 		 driver.get(applicationURL);
 	 	 		  ...
 	 	 		  try
 	 	 		  {
 	 	 			 MyWaitVar30Sec.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='j_username']"))); 
 	 	 		...
 	 	 		MyWaitVar10Sec.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("html/body/center/h1/span[2]")));
 		...
 		// trying to take screen shot before submitting the Login credentials	
 	        ...
 	        String expectedTitlehomepage = "Farebroker - Home Page";
 	        
 	        // compare the actual title of the page with the expected one and print the result as "Passed" or "Failed"
 	        
 	        if (actualTitlehomepage.contentEquals(expectedTitlehomepage))
 	        {
 	        ...
 	        System.out.println ("Title of launched page is : "+ actualTitlehomepage);
	...
	for (int i = 1; i < rowCount+1; i++) 
		{
			...
			driver.findElement(By.xpath(".//*[@id='arrow_icon']")).click();
			System.out.println ("Search expand button clicked");
			...
			driver.findElement(By.id("originSId")).sendKeys(originAirport);
			...
			if (typeOfSearch.equals("RT"))
			{
				...
				driver.findElement(By.xpath(".//*[@id='alternateSto']")).sendKeys("2015/10/15");
 	 ...
 	 public void verifyResults(String typeOfSearch, String originAirport, String DestinationAirport) throws IOException
 	 {
 		...
 		else 
		{
 		 ...
 		 List<WebElement> totalProductsinFirstPage =  driver.findElements(By.xpath(".//*[@id='example']//*[@class='prdouct_develop_grp']"));
			...
			String deptDate = driver.findElement(By.xpath(".//*[@id='deptDateId']")).getText();
			
			
			if (typeOfSearch.equals("RT"))
			{	
				String retDate = driver.findElement(By.xpath(".//*[@id='retDateId']")).getText();
 	...
 	// The following code is clicking each book button displayed in shopping page
	 			
	/*		
			try
			{
			 System.out.println ("\n Verifying Book button/CheckSeat Availability/Check Fare of each product in First Page");
			 System.out.println (" ************************************************************************************\n");
 				...
 				for(int j = 0;j < bookButtonClick.size(); ++j) 
 				{
 					 ...
 					 WebElement checkbox = bookButtonClick.get(k); 
 					 checkbox.click();
 				     int m = k+1;
 				     try
 				     {
 				    MyWaitVar30Sec.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='product_detail']/div[11]/div[1]/button"))); // waiting till Search page3 is shown in page
 				     ...
 				     {
 				    	System.out.println ("\nSome issues/Warning message found after clicking book button of "+m+"th product"); 
 				    	try
 				    	{
 				     ...
 				     System.out.println ("\nBook button of "+ m + "th product clicked and reached page3 successfully");
 				     driver.findElement(By.xpath(".//*[@id='product_detail']/div[11]/div[1]/button")).click();
 				     								
 					 //System.out.println ("We are back to product list page");
 				    MyWaitVar30Sec.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[starts-with(@id,'bookButtonId')]/button"))); // waiting till Search page3 is shown in page
 				   k=k+1; 
 										
 				}
 				
 				
 				System.out.println ("\n Verified Book button functionality of each product in First Page");
 			
			}
			
			catch(Exception BookButtonError)
			{
				System.out.println ("\n Some issues found while trying to click on Book button: "+BookButtonError);
 	...
 	*/		
			...
			//{
 				...
 				try
 				{
				    	...
				    	// checking for warning message
 					 		MyWaitVar60Sec.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@onclick='goBack()']")));
 					 		String fareCheckFail = driver.findElement(By.xpath(".//*[@id='fareRuleErrMsg']")).getText();
 					 		System.out.println ("Warning Message: "+fareCheckFail);	
 					 	 ...
 					 	 try
 			    		{
 	 					   // checking for Change in price warning message
 			    		String changeInPrice = driver.findElement(By.xpath(".//*[@id='priceChangeId']")).getText();
 			    		System.out.println ("Warning Message: "+changeInPrice);	
 				    	 ...
 				    	 {
 				    		waittimeShort(); 
 				    		//MyWaitVar10Sec.until(ExpectedConditions.elementToBeClickable((By.xpath(".//*[@value='Check Fare']"))));
 				    		driver.findElement(By.xpath(".//*[@value='Check Fare']")).click();
 				    		System.out.println ("Clicked on Check Fare button");
 				    		waittimeShort();
 				    			try
 				    			{
 					    	// checking for warning message
 				    	 ...
 				    	 catch (Exception FareCheckError)
 				    	 { 
 				    		 System.out.println ("Check Fare button not found");
 				    	 }
 				    	 
 				    	 
 				    	 try
 				    	 {	waittimeShort(); 
 				    		//MyWaitVar30Sec.until(ExpectedConditions.elementToBeClickable((By.xpath(".//*[@value='Check Seat Availability']"))));
 				    		driver.findElement(By.xpath(".//*[@value='Check Seat Availability']")).click();
 				    		System.out.println ("Clicked on Check Seat availability button");
 				    		waittimeShort();
 				    	 }
 				    	catch (Exception CheckSeatAvailabilityError)
				    	 { 
				    		 System.out.println ("Check seat availability button not found");
				    	 }
 				    
 				    	 
 				    	 try
 	 				     {
 				    		MyWaitVar60Sec.until(ExpectedConditions.elementToBeClickable((By.xpath(".//*[@onclick='goBack()']"))));
 				    		driver.findElement(By.xpath(".//*[@onclick='goBack()']")).click();
 				    		System.out.println ("Back to listing page"); 
 				    		//waittimeShort();
 				    		MyWaitVar60Sec.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[starts-with(@id,'bookButtonId')]/button"))); 
 				    		System.out.println ("waiting over"); 
 	 				     }
 				    	 
 				    	catch (Exception BackToListing)
				    	 { 
				    		 System.out.println ("Back to listing button not found");
				    	 }
				    	 ...
				    	 { 
				    		 System.out.println ("Some issues found in clicking on Book button");
				    	 }
 				    	 
 				}     
 				    // catch (Exception WanringMessage)
 				    // {
 				    //	System.out.println ("\nBook button of "+ m + "th product clicked and Warning message found");
 				...
 				catch (Exception BookButtonError2)
 				
 				{
 					System.out.println ("\n Some issues found while trying to click on Book button: "+BookButtonError2);
 				}
		...
		//The following code verifies the bonus benefit of each product
	 					...
	 					System.out.println ("\nVerifying Bonus benefit of each product");
	 	 				System.out.println ("*********************************\n");
	 	 				List<WebElement> allBonusBenefitDisplayed =  driver.findElements(By.xpath("(//*[starts-with(@id,'bonusBenifits')])"));
	 	 				...
	 	 				{
	 	 					allBonusBenefitDisplayed =  driver.findElements(By.xpath("(//*[starts-with(@id,'bonusBenifits')])"));
	 	 					WebElement bonusBenefit = allBonusBenefitDisplayed.get(bfcounter); 
	 	 					int productCouunter= bfcounter +1;
	 	 				   System.out.println ("Bonus benefit of "+ productCouunter + "th product: " + bonusBenefit.getAttribute("bt-xtitle"));
	 	 				}
