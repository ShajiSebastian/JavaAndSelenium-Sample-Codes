...
public class Test_One {
 ...
 public void testCaseOne_Test_One() {
  System.out.println("Executing testCase1 of Test_One");
  ...
  System.out.println("Result of testCase1 of Test_One = "+Result);
 }
 
 @Test(priority=2)
 public void testCaseTwo_Test_One() {
  System.out.println("Executing testCase2 of Test_One");
  ...
  driver.findElement(By.xpath("//input[@id='equals']")).click();
  String Result = driver.findElement(By.xpath("//input[@id='Resultbox']")).getAttribute("value");
  System.out.println("Result of testCase2 of Test_One = "+Result);
 }
}