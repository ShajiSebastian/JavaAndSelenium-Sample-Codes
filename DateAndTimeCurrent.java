...
public class DateAndTimeCurrent 
{
	...
	{
		System.out.println ("Execution starts for Current date and time...");
		
		Date date = new Date();
		System.out.println("IST time  : " +date);
		
		SimpleDateFormat dateformat = new SimpleDateFormat("dd-MM-yyyy hh:mm a");
		dateformat.setTimeZone(TimeZone.getTimeZone("Japan"));
			
	    System.out.println("Japan time: " +dateformat.format(date));
