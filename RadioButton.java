...
public class RadioButton 
{
	...
	public static void main(String args[]) throws IOException
	{
		...
		List<WebElement> radiobuttons = driver.findElements(By.id("searchTypeId"));
	
		int buttoncount = radiobuttons.size();
		System.out.println ("Button counts: "+buttoncount);
		
		for (WebElement buttonNames : radiobuttons)
		{
			String sValue = buttonNames.getAttribute("Value");
			System.out.println("Button Name: "+ sValue);
		}
		 
		
		driver.findElement(By.cssSelector("input[value='OW']")).click();
	
		boolean buttonstatus =driver.findElement(By.cssSelector("input[value='OW']")).isSelected();
