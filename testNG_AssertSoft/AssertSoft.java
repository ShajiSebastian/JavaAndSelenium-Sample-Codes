...
public class AssertSoft 
{
   ...
   public void hard_assert_text() 
  {
   ...
   System.out.println("Hard Actualtext "+Actualtext);
   System.out.println("Hard Expectedtext 'Tuesday, 01 January 2014'");
   ...
   Assert.assertEquals(Actualtext, "Tuesday, 28 January 2014", "2nd assert PASS.");
   ...
   System.out.println("Hard Actual AlertText "+Alert_text);
   System.out.println("Hard Expected AlertText 'Hi.. is alert message!");
